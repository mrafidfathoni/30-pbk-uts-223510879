      ...
      <section class="todo-section">
        ...
        <section class="create-todo">
          ...
          <form id="new-todo-form" @submit.prevent="addTodo">
            ...
            <input type="text" name="content" id="content" placeholder="Tuliskan" v-model="input_content" />
        ...
        <section class="todo-list">
          ...
          <div class="list" id="todo-list">
            <div v-for="todo in todos_asc" :class="['todo-item', { 'done': todo.done }]" :key="todo.id">
              <label>
